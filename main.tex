...
%% Rune: NEEDED for Appendix Math formula
\DeclareUnicodeCharacter{03B5}{$\epsilon$}
\DeclareUnicodeCharacter{03BC}{$\mu$} %U+03BC = my (micro)
\DeclareUnicodeCharacter{2218}{$\circ$} %U+2218 = circle
\DeclareUnicodeCharacter{222B}{$\int$} %U+222B = integral
\DeclareUnicodeCharacter{222E}{$\oint$} %U+222E = Circle integral
...
\input{chapters/07_future_works}
...
\begin{acronym}
	...
	\acro{GPT}[GPT]{Generative Pre-trained Transformers}
	\acro{GPU}[GPU]{Graphical Processing Units}
	\acro{LLMs}[LLMs]{Large Language Models}
	\acro{NLP}[NLP]{Natural Language Processing}
	\acro{MLP}{Mathematical Language Processing}
