...
%% It's also unclear if "itself" makes any difference for "p" and "p"?
...
\begin{enumerate}
    ...
    %% Question to Aamin. So you can have multiple identical keys x in your dictionary, then?
    %% One dictionary for each paper?
